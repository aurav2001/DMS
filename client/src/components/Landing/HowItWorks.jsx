    ...
    <section className="py-16 sm:py-20 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-14 lg:mb-16">
          ...
          <p className="text-base sm:text-lg text-slate-600 px-2">Simple steps to streamline your document workflow.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {steps.map((step, index) => (
            ...
            >
              <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-primary-100 text-primary-600 rounded-2xl text-xl sm:text-2xl font-bold mb-4 sm:mb-6 relative z-10">
                {step.number}
              </div>
              ...
              <p className="text-sm sm:text-base text-slate-600 px-2 sm:px-0">{step.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
